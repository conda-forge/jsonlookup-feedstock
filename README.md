...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jsonlookup-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10548&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jsonlookup-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jsonlookup` can be installed with:

```
conda install jsonlookup
```

It is possible to list all of the versions of `jsonlookup` available on your platform with:
